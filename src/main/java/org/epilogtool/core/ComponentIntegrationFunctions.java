...
public class ComponentIntegrationFunctions {
	...
	/**
	 * Translates an Integration Function (IF) from string to
	 * IntegrationFunctionExpression. Calls the parse to check if the IF is
	 * correctly written.
	 * 
	 * @param expr
	 * @return
	 ...
	 */
	private IntegrationFunctionExpression string2Expression(String expr) throws RuntimeException {
	...
	/**
	 * Sets a integration function to a level, both at string level and
	 * IntegrationFunctionExpression level.
	 * 
	 * @param value
	 * @param function
	 * @throws RecognitionException
	 * @throws RuntimeException
	 */
	public void setFunctionAtLevel(byte value, String function) throws RuntimeException {

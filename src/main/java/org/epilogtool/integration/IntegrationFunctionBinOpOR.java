...
public class IntegrationFunctionBinOpOR extends IntegrationFunctionBinOp {
	public IntegrationFunctionBinOpOR(IntegrationFunctionExpression expr1, IntegrationFunctionExpression expr2) {
		super(expr1, expr2);
	}

...
public class IntegrationSignalBinOpOR extends IntegrationSignalBinOp {
	public IntegrationSignalBinOpOR(IntegrationSignalExpression expr1, IntegrationSignalExpression expr2) {
		super(expr1, expr2);
	}

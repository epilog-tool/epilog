...
public class PerturbationsPanel extends JPanel {
	...
	/**
	 * Generates the perturbations panel, to be inserted in the tab on Epilog's
	 * main panel.
	 * 
	 * @param mainFrame
	 */
	...
	/**
	 * Initializes the perturbations panel.
	 */
	...
	public void init() {
		...
		if (this.mainFrame.epithelium.loadedPerturbations != null)
			for (int i = 0; i < this.mainFrame.epithelium.loadedPerturbations
					.size(); i++)
				listModel
						.addElement(this.mainFrame.epithelium.loadedPerturbations
								.get(i));
		...
		if (this.mainFrame.epithelium.loadedMutations != null)
			for (int i = 0; i < this.mainFrame.epithelium.loadedMutations
					.size(); i++)
				mutationsListCombo
						.addItem(this.mainFrame.epithelium.loadedMutations
								.get(i));
	...
	/**
	 * Deletes a perturbation from the list of perturbations.
	 */
	...
	/**
	 * Deletes a mutation from the list of mutations.
	 */
	...
	/**
	 * Generates the right Panel of the perturbations Panel.
	 * 
	 * @return panel
	 */
	...
	/**
	 * Sets the selected perturbation as active
	 * 
	 * @param selectedPerturbedComponent
	...
	/**
	 * Sets the index of the selected perturbation.
	 * 
	 * @param i
	 *            index
	 */
	...
	/**
	 * 
	 * Sets the minimum value of the the perturbation.
	 * 
	 * @param min
	 *            minimum value of the the perturbation
	 */
	...
	/**
	 * Sets the maximum value of the perturbation.
	 * 
	 * @param max
	 *            maximum value of the perturbation
	 */
	...
	/**
	 * Sets the maximum value for a component. The component is associated with
	 * an index from the node list.
	 * 
	 * @param index
	 *            index of the node
	 */
	...
	/**
	 * Draws the JComboBoxes with the maximum and minimum values
	 * 
	 * @param centerPanel
	 */
	...
	/**
	 * Sets a perturbation as the active perturbation.
	 * 
	 * @param string
	 *            perturbation as string
	 */
	...
	/**
	 * Clears all hexagons of perturbations.
	 */
	...
	/**
	 * Marks all hexagons with the selected perturbation.
	 */
	...
	/**
	 * Saves the selected mutation to the list of mutations.
	 */
	...
	/**
	 * Sets the active perturbation in the epithelium.
	 * 
	 * @param combo
	 */
	private void setActivePerturbation(JComboBox combo) {
		this.mainFrame.epithelium
				.setActivePerturbation((AbstractPerturbation) combo
						.getSelectedItem());
	}
	...
	/**
	 * Adds a perturbation set. If a name is already used, then the new set
	...
	/**
	 * Load selected perturbation set and refresh the hexagons panel.
	 */
...
/**
 * Return perturbation in the form of a list of strings
 ...
 */
	...
	/**
	 * Return mutations in the form of a list of Abstract Perturbations

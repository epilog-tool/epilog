...
import org.cellularasynchrony.Topology;
...
public class CompositionContextImpl implements CompositionContext {
	...
	public List<Integer> getNeighbourIndices(int instance, int minDistance,
		...
		List<Integer> results = topology.getNeighboursTotal(instance,
				maxDistance);
		List<Integer> frontier = topology.getNeighboursTotal(instance,
				minDistance - 1);

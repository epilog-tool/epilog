...
public class MainFrame extends JFrame {
	...
	public LRGUpdateModePanel lrgUpdateModePanel = null;
	public InitialConditions initial = null;
	public StochasticSimulationPanel stochasticSimulationPanel = null;
	...
	public StochasticSimulation stochasticSimulation;
...
//		startPanel.setBackground(Color.RED);
	...
	public void initializePanelCenter() {
		...
		this.stochasticSimulation = new StochasticSimulation(this);
	...
	public void initializePanelCenterRight() {
		...
		lrgUpdateModePanel = new LRGUpdateModePanel(this);
		simulationSetupPanel = new SimulationSetupPanel(this);
		stochasticSimulationPanel = new StochasticSimulationPanel(this);
		...
		tabbedPane.addTab("LRG Update Mode", lrgUpdateModePanel);
		tabbedPane.setMnemonicAt(0, KeyEvent.VK_1);

		tabbedPane.addTab("Stochastic Simulations", stochasticSimulationPanel);
		tabbedPane.setMnemonicAt(0, KeyEvent.VK_1);
		...
		tabbedPane.setBackgroundAt(5, Color.gray);
	...
	protected void setStochastic(boolean b) {
		this.stochastic = b;
	...
	public void disableTabs(Boolean bool) {
		...
		tabbedPane.setEnabledAt(5, !bool);
	}
	 ...
	 *            iteration number
	 */
	public void setBorderHexagonsPanel(int iterationNumber, int cellIteration) {
		...
		if (iterationNumber != 0){
			titleInitialConditions = BorderFactory
					.createTitledBorder("Simulation Iteration: "
							+ iterationNumber + "  Cell Iteration: " + cellIteration);
		}
		else
			titleInitialConditions = BorderFactory

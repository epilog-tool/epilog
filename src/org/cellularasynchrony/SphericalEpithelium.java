...
import org.cellularasynchrony.io.FileIO;
import org.cellularasynchronyIntegration.IntegrationFunctionSpecification;
...
public class SphericalEpithelium implements Epithelium {
	...
	public NodeInfo getString2Node(String str){
		return string2Node.get(str);
	}
}
